...
set nf [open stop-n-wait-arq.nam w]
$ns namtrace-all $nf
set f [open stop-n-wait-arq.tr w]
$ns trace-all $f
...
$ns at 0.0 "$ns trace-annotate \"Stop and Wait ARQ\""
...
proc finish {} {
	...
	puts "filtering..."
	exec tclsh /home/administrator/ns-allinone-2.35/nam-1.15/bin/namfilter.tcl stop-n-wait-arq.nam
        puts "running nam..."
        exec nam stop-n-wait-arq.nam &
	exit 0
}
