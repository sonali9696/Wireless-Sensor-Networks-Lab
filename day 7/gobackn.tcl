...
set nf [open gobackn.nam w]
$ns namtrace-all $nf
set f [open gobackn.tr w]
$ns trace-all $f
...
$ns at 2.11 "$ns trace-annotate \"Receive Ack_15\""
$ns at 2.20 "$ns trace-annotate \"Receive 6 more Ack_17to22\""
$ns at 2.32 "$ns trace-annotate \"Send Packet_23\ : Send only 1 packet cause of window size\""

$ns at 2.48 "$ns trace-annotate \"Re-send lost Packet_16 along with 17,18,19,20,21,22,23 : Set window size to 8 \""
$ns at 2.72 "$ns trace-annotate \"Receive Ack_16to23\""
$ns at 2.91 "$ns trace-annotate \"Send Packet_24,25 : set window size to 2\""
...
proc finish {} {
        ...
        puts "filtering..."
        exec tclsh /home/administrator/ns-allinone-2.35/nam-1.15/bin/namfilter.tcl gobackn.nam
        puts "running nam..."
        exec nam gobackn.nam &
        exit 0
}
