...
$ns namtrace-all $nf
set f [open selective-repeat.tr w]
$ns trace-all $f
...
$ns at 2.55 "$ns trace-annotate \"Receive Ack_16\""
...
proc finish {} {
        ...
        puts "filtering..."
        exec tclsh /home/administrator/ns-allinone-2.35/nam-1.15/bin/namfilter.tcl selective-repeat.nam
        puts "running nam..."
